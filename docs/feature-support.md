...
| Responsive phone web UI | Yes | N/A | N/A | N/A | N/A |
...
The web UI supports desktop, tablet, and phone breakpoints. Native Android and iOS remain the primary phone experience, but the browser UI keeps navigation, search, file actions, previews, trash, admin, and upload status usable on small screens.
